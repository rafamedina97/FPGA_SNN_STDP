...
set_property PACKAGE_PIN A20      [get_ports rx] ;# Bank  28 VCCO - VCC1V8   - IO_L21P_T3L_N4_AD8P_28
set_property IOSTANDARD  LVCMOS18 [get_ports rx] ;# Bank  28 VCCO - VCC1V8   - IO_L21P_T3L_N4_AD8P_28
set_property PACKAGE_PIN D5       [get_ports {leds[0]}] ;# Bank  88 VCCO - VCC3V3   - IO_L11N_AD9N_88
set_property IOSTANDARD  LVCMOS33 [get_ports {leds[0]}] ;# Bank  88 VCCO - VCC3V3   - IO_L11N_AD9N_88
set_property PACKAGE_PIN D6       [get_ports {leds[1]}] ;# Bank  88 VCCO - VCC3V3   - IO_L11P_AD9P_88
set_property IOSTANDARD  LVCMOS33 [get_ports {leds[1]}] ;# Bank  88 VCCO - VCC3V3   - IO_L11P_AD9P_88
set_property PACKAGE_PIN A5       [get_ports {leds[2]}] ;# Bank  88 VCCO - VCC3V3   - IO_L10N_AD10N_88
set_property IOSTANDARD  LVCMOS33 [get_ports {leds[2]}] ;# Bank  88 VCCO - VCC3V3   - IO_L10N_AD10N_88
set_property PACKAGE_PIN B5       [get_ports {leds[3]}] ;# Bank  88 VCCO - VCC3V3   - IO_L10P_AD10P_88
set_property IOSTANDARD  LVCMOS33 [get_ports {leds[3]}] ;# Bank  88 VCCO - VCC3V3   - IO_L10P_AD10P_88
set_property PACKAGE_PIN AH17      [get_ports {clk_in1_n}] ;# Bank  28 VCCO - VCC1V8   - IO_L13N_T2L_N1_GC_QBC_28   300MHz pos
set_property IOSTANDARD  DIFF_SSTL12     [get_ports {clk_in1_n}] ;# Bank  28 VCCO - VCC1V8   - IO_L13N_T2L_N1_GC_QBC_28
set_property PACKAGE_PIN AH18      [get_ports {clk_in1_p}] ;# Bank  28 VCCO - VCC1V8   - IO_L13P_T2L_N0_GC_QBC_28   300MHz neg
set_property IOSTANDARD  DIFF_SSTL12     [get_ports {clk_in1_p}] ;# Bank  28 VCCO - VCC1V8   - IO_L13P_T2L_N0_GC_QBC_28
set_property PACKAGE_PIN B3       [get_ports start] ;# Bank  88 VCCO - VCC3V3   - IO_L6N_HDGC_88
set_property IOSTANDARD  LVCMOS33 [get_ports start] ;# Bank  88 VCCO - VCC3V3   - IO_L6N_HDGC_88
set_property PACKAGE_PIN C3       [get_ports reset] ;# Bank  88 VCCO - VCC3V3   - IO_L6P_HDGC_88
set_property IOSTANDARD  LVCMOS33 [get_ports reset] ;# Bank  88 VCCO - VCC3V3   - IO_L6P_HDGC_88
