...
HD_PWD='C:/Users/rafam/VivadoProjects/SNN_UART/SNN_UART.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_SNN_uart.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_SNN_uart.tcl
