...
HD_PWD='C:/Users/rafam/VivadoProjects/SNN_UART/SNN_UART.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_SNN_uart.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_SNN_uart.tcl -notrace
